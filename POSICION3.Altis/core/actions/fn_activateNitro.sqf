...
if ((speed _vehicle) <= 10) exitWith { systemChat format ["Debes estar a mas de 10km/h para activar el Nitro."]; };
...
_speed = 40; //how much you want to add speed for the vehicle
