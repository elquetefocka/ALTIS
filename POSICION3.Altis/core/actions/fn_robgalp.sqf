...
if (_cops < 2) exitWith {
hint format ["La Galp no puede ser robado por que no hay %1 policias online.", _cops];};
...
[[2,"La Galp esta siendo atracada!!"],"life_fnc_broadcast",east,false] spawn life_fnc_MP;
[[2,"La Galp esta siendo atracada!!"],"life_fnc_broadcast",west,false] spawn life_fnc_MP;
