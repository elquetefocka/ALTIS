...
hint format ["Robando la gasolinera !Espera %1 seg.",_timer];
...
[[2,format["$$$ %1 esta atracando una gasolinera.$$$",name player]],"life_fnc_broadcast",east,false] spawn life_fnc_MP;
...
while {true} do{ //Kraken Clean-Up: changed to while true do:
		...
		_marker = createMarker ["Marker2", _Pos]; //by ehno: Place a Maker on the map
		"Marker2" setMarkerColor "ColorRed";
		"Marker2" setMarkerText "!ATENCION! SE ESTA ROBANDO !ATENCION ZONA RDM!",name player;
		"Marker2" setMarkerType "mil_warning";	
...
deleteMarker "Marker2"; // by ehno delete maker
