...
titleText["Has sido enviado a la carcel, espera tu tiempo. Si tu  Si intenta reaparecer o volver a conectar su tiempo aumentará!","PLAIN"];
hint "Por ser detenido que ha perdido las siguientes licencias que usted posee\n\nLicencia de Armas";
