...
if(_curTarget isKindOf "House_F") exitWith {
	if((nearestObject [[15474.214,15698.04,0],"Land_Dome_Big_F"]) == _curTarget OR (nearestObject [[15474.214,15698.04,0],"Land_Research_house_V1_F"]) == _curTarget OR (nearestObject [[16640.793,15695.068,5.5576954],"Land_Cargo_Tower_V1_No5_F"]) == _curTarget OR (nearestObject [[16677.453,15715.972,10.5],"Land_Cargo_Tower_V1_No5_F"]) == _curTarget) then {
