...
if(count _vehicleInfo == 0) exitWith {hint " vehiculo vacio"};
...
if(_value > 0) then
{
	[[0,format["vehículo fue buscado y tiene $%1 en drogas / contrabando.",[_value] call life_fnc_numberText]],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	life_atmcash = life_atmcash + _value;
	_vehicle setVariable["Trunk",[],true];
}
	else
{
	hint "Nada ilegal en este vehiculo.";
};