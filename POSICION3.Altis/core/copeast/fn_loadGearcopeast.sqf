...
_loadout = copeast_gear;

if(isNil "_loadout") exitWith {[] call life_fnc_copeastDefault;}; //Slot data doesn't exist
if(count _loadout == 0) exitWith {[] call life_fnc_copeastDefault;}; //Slot data doesn't exist
