...
if((nearestObject [[15473.15,15705.463,-0.018241169],"Land_Dome_Big_F"]) == _building OR (nearestObject [[15473.15,15705.463,-0.018241169],"Land_Research_house_V1_F"]) == _building) then {
	[[[1,2],"!!!!! ALGUIEN ESTA INTENTANDO ENTRAR EN EL BANCO CENTRAL !!!!!!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
} else {
	[[0,format["%1 fue visto intentando entrar en una casa.",profileName]],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
};
