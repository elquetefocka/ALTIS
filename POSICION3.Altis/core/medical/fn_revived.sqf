...
hint format["%1 fue revivido y tu recibiste una recompensa de $%2 fue tomada de su cuenta bancaria por tus servicios.",_medic,[(call life_revive_fee)] call life_fnc_numberText];
