...
_val = ctrlText 2010;
ctrlShow[2002,false];
if((lbCurSel 2023) == -1) exitWith {hint "Nadie fue seleccionado!";ctrlShow[2002,true];};
_unit = lbData [2023,lbCurSel 2023];
_unit = call compile format["%1",_unit];
if((lbCurSel 2005) == -1) exitWith {hint "No ha seleccionado un elemento que quería dar.";ctrlShow[2002,true];};
...
if(!([_val] call fnc_isnumber)) exitWith {hint "No ha introducido un formato de número valido";ctrlShow[2002,true];};
