...
if(_selection == -1) exitWith {hint "No seleccion";};
...
_price ctrlSetStructuredText parseText format ["Precio: <t color='#8cff9b'>$%1</t>",[(_control lbValue _selection)] call life_fnc_numberText];
