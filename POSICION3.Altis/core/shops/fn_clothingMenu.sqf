...
{
	if(!(missionNamespace getVariable (_var select 0))) exitWith {hint format["Necesitas %1 para comprar en esta tienda!",[_var select 0] call life_fnc_varToStr]; closeDialog 0;};
};
