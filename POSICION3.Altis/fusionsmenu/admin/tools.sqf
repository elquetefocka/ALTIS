...
if ((getPlayerUID player) in ["76561198073018581","76561198058129631","76561198115600821","76561198056350684"]) then { //all admins
	if ((getPlayerUID player) in ["76561198073018581","76561198058129631","76561198115600821","76561198056350684"]) then { //Admins Go Here aswell
		adminmenu =
		[
			["Fusions Menu",true],
				...
				["ESP", [8], "", -5, [["expression", format[_EXECscript1, "ESP.sqf"]]], "1", "1"],
				["Spectate Player", [9],  "", -5, [["expression", format[_EXECscript1,"spectate.sqf"]]], "1", "1"],
				["", [-1], "", -5, [["expression", ""]], "1", "0"],
...
[
	...
	//Add Weapons Here Gave some examples :D
		...
		["crate", [7],  "", -5, [["expression", format[_EXECscript3,"fillCrate.sqf"]]], "1", "1"],
...
[
	...
	//Add Weapons Here Gave another page because it could get a little confusing :P
		["MX", [2],  "", -5, [["expression", format[_EXECscript3,"mx.sqf"]]], "1", "1"],
		["Clean", [3],  "", -5, [["expression", format[_EXECscript3,"clean.sqf"]]], "1", "1"],
		["Exit", [13], "", -3, [["expression", ""]], "1", "1"]
...
[
	["Vehicles",true],
		...
		["Littlebird", [6],  "", -5, [["expression", format[_EXECscript5,"heli.sqf"]]], "1", "1"],
		["Hatchback", [7],  "", -5, [["expression", format[_EXECscript5,"hatchback.sqf"]]], "1", "1"],
		["Kart", [8],  "", -5, [["expression", format[_EXECscript5,"kart.sqf"]]], "1", "1"],
		["", [-1], "", -5, [["expression", ""]], "1", "0"],
