...
switch (_side) do {
	...
	case civilian:{_query = format["UPDATE players SET name='%1', cash='%2', bankacc='%3', civ_gear='%4', civ_licenses='%5', arrested='%7', civPosition='%8', alive='%9' WHERE playerid='%6'", _name, _cash, _bank, _gear, _licenses, _uid, _arrested, _civPosition, _alive];
